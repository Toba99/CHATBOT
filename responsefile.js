const  responses = {
    greetings: ["Hey, how are you doing today? Please enter your symptoms, e.g (Cough, Headache, e.t.c)"],
  ...
  const  recommendations = {
    get_headache: ["Make sure you rest and sleep well please or see a doctor if headache grows into migrines or thunderclap headaches"],
  ...
  const  symptoms = {
    get_headache: ["The symptoms for headache deep and constant pain in the cheekbones, forehead, or bridge of the nose. Pain that gets worse with sudden head movement or straining."],
  ...
  const  causes = {
    get_headache: ["Headaches are mostly caused by stress, illnesses, change in environment, genetics, etc."],
  ...
  const  drugs = {
    get_headache: ["Treatment: Take paracetamol or tramadol, and if headache persists, see a Doctor"],
  ...
  const allIntents={intss:["greetings","jokes","get_headache","get_malaria","get_typhoid","get_hayfever","get_sinusitis","get_commoncold","get_backpain","get_flu","noresponse"]}
